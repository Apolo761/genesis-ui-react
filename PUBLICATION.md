...
3. Revise `npm pack --dry-run`: apenas `dist`, README, licença e aviso devem entrar no pacote npm.
...
O repositório GitHub hospeda somente a biblioteca, o build pronto e a documentação. Instale a versão publicada com `npm install genesis-ui-react`; a tag do GitHub continua disponível com `npm install github:Apolo761/genesis-ui-react#v0.2.0`.
