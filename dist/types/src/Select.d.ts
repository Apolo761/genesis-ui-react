...
export declare function Select({ label, selectedLabel, value, options, onChange, disabled, hint, inlineLabel, labelClassName, wideMenu, showSelectedMeta }: SelectProps): import("react").JSX.Element;
